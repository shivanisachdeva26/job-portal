...
const Header = () => {
  ...
  return (
   ...
   <nav className='py-4 flex justify-between items-center'>
    ...
    <Button variant="outline" onClick={()=>setShowSignIn(true)}>Login</Button>
      ...
      <SignedIn>
        ...
        <Button variant="destructive" className="rounded-full">
          <PenBox size={20} className='mr-2'/>Post Job</Button>
        </Link>)}
    ...
    {showSignIn && (<div className='fixed inset-0 flex items-center justify-center  bg-black bg-opacity-50 z-10' onClick={handleOverlayClick}> 
