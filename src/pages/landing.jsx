    ...
    <main className='flex flex-col gap-10 sm:gap-20 py-10 sm:py-20'>
      <section className='text-center'>
        <h1 className='flex flex-col items-center justify-center gradient-title text-4xl font-extrabold sm:text-6xl lg:text-8xl tracking-tighter py-4'>Find Your Dream Job {" "} 
          <span className='flex items-center gap-2 sm:gap-6'>and get {" "} <img src="/logo.png" alt="Hirrd logo" className='h-14 sm:h-24 lg:h-32' /></span>
        </h1>
     ...
     <Button variant="destructive" size="xl">Post a Job</Button>
        ...
        <Carousel plugins={[Autoplay({delay: 1500})]} className="w-full py-10 z-0">
